...
from .views import RoastListView, BeanListView, RoastDetailView, BeanDetailView, FileListView, RoastCreate

urlpatterns = [
    path('', TemplateView.as_view(template_name="home.html")),
    path('roasts/', RoastListView.as_view(template_name="roast/list.html")),
    path('roasts/new/', RoastCreate.as_view(), name="roast-new"),
